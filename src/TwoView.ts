...
import { IDrawOptions } from "./TwoDraw";
...
export default class TwoView {
  ...
  constructor(world: any, options: IViewOptions = {}) {
  ...
  drawPatches(data?: any, pixelFcn?: any) {
    if (data != null) {
      this.patchesView.setPixels(data, pixelFcn);
    }
